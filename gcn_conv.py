...
def remove_less_edges(edge_index, edge_attr,threshold=1e-5):
...
class GCNConv(MessagePassing):
    ...
    def reset_parameters(self):
        glorot(self.weight) #xavier初始化
        zeros(self.bias) #零初始化
        self.cached_result = None
    ...
    def norm(edge_index, num_nodes, edge_weight, improved=False, dtype=None):
        ...
        # edge_index, edge_weight = remove_less_edges(edge_index,edge_weight)
        edge_index, edge_weight = remove_self_loops(edge_index, edge_weight) #去掉自连接
